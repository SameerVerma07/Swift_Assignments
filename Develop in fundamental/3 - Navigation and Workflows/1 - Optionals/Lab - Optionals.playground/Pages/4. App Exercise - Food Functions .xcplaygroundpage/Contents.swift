...
func foodLogged(food : String)-> Meal?

{
    let foodConsumed : Meal? = meals[food]
    if let mealrecord = foodConsumed{
        return mealrecord
    }
    return nil
}
print(foodLogged(food: "Breakfast"))
print(foodLogged(food: "Lunch"))
/*:
