...
var stock = ["Chips": 15, "Donuts": 6, "Juice": 0, "Apple": 9, "Banana": 15, "Broccoli": 7]

func itemsName(item:String)->Double?
{
    var price : Double?
    for (items, num) in stock
    {
        if items == item && num > 0
        {
            price = prices[item]
...
var itemRequired = "Juice"
print(itemsName(item: itemRequired))
/*:
